...
public class LazyLoadingErrorSolution_Option1_Demo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// this is the option one of calling getter method earlier when session is open,
			// the data will be loaded into the memory
